...
Model Building and Evaluation (Logistic Regression, Decision Tree, Random Forest, XGBoost, Support Vector Machines)
...
While it's also important not to misclassify loyal customers as potential churners (false positives), the cost of reaching out to a satisfied customer is generally lower than the cost of losing a customer who could have been retained with proper intervention. This is why I will use metrics that emphasize the correct identification of churners instead of accuracy. To create model, that correctly predicting the churned customers I am going to focusing on these metrics:
...
The dataset used in this project is from Kaggle: [E-commerce Customer Churn](https://www.kaggle.com/datasets/ankitverma2010/ecommerce-customer-churn-analysis-and-prediction). It contains various customer attributes and a target variable indicating whether a customer has churned.
